...
namespace vt
{
	...
	{
		Int2 const position;  // The new position of the mouse in window coordinates.
		Int2 const direction; // The direction the mouse was moved in. Positive x is right, positive y is up.
