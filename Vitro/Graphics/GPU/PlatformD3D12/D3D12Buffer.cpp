...
module vt.Graphics.D3D12.Buffer;
...
namespace vt::d3d12
{
	D3D12_RESOURCE_DESC fill_resource_desc(BufferSpecification const& spec)
	{
		return {
	...
	D3D12Buffer::D3D12Buffer(BufferSpecification const& spec,
	...
	void D3D12Buffer::initialize_resource(BufferSpecification const& spec, D3D12MA::Allocator& allocator)
	{
	...
	void D3D12Buffer::initialize_descriptor(BufferSpecification const& spec, ID3D12Device4& device, DescriptorPool& pool)
	{
